#ifndef BLUE_STATE_H_INCLUDED
#define BLUE_STATE_H_INCLUDED

#include "base_state.h"
#include "red_state.h"


class blue_state : public base_state
{
public:
    ...
    {
        gEngine->window.clear(sf::Color(0, 0, 255));   //Fill the prospective screen with purple
